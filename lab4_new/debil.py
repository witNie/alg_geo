...
class Segment:
    ...
    def __gt__(self, other):
        ...
        return self.startP[1] + incline * Segment.x > other.startP[1] + incline2 * Segment.x \
               or (self.startP[1] + incline * Segment.x == other.startP[1] + incline2 * Segment.x and incline < incline2)
...
# print(if_intersect(Segment((0,1),(2,2), 0), Segment((0,0),(2,4), 1)))
#
# a = Segment((0,0),(2,2),0)
#
# b = Segment((0,-1),(2,5),1)
# Segment.move_sweep(0)
# Q = SortedSet()
# Q.add(a)
# Segment.move_sweep(2)
# Q.add(b)
# printSet(Q)
# print(Q.index(Segment((0,0),(2,2),0)))

# g = SortedSet([((0, 0), 0, 0), ((0, 4), 0, 1), ((3, 2), 0, 2), ((4, 4), 1, 0), ((4, 0), 1, 1), ((4, 5), 1, 2)])
# g.add(((2.0, 2.0), 1, 3))
# printSet(g)
